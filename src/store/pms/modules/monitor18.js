...
const monitor18 = {
    ...
    actions: {
        handleGraphData({ rootState, state, commit }) {
            ...
            axios
                .post(`${rootState.globalIP}/api/v1/vcb/discharge`, params)
                .then((data) => {
            ...
            //알람
            axios.get(`${rootState.globalIP}/api/v1/vcb/alarm`).then((data) => {
                const datas = data.data.datas;
                if (datas.length !== 0) {
        ...
        handleDatePicker({ rootState, state, commit }) {
            ...
            axios
                .post(`${rootState.globalIP}/api/v1/vcb/detailInfo`, params)
                .then((data) => {
        ...
        getPumpInfo({ rootState, commit }) {
            axios
                .get(`${rootState.globalIP}/api/v1/vcb/info`)
                .then((data) => commit('getPumpInfo', data.data.datas));
        },
    },
};

export default monitor18;
