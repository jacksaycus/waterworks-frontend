...
export default {
    props: ['title', 'detailData1', 'detailData2', 'name1', 'name2'],
    setup(props) {
        ...
        watch(state, () => {
            // console.log('state:::');
            state.current1 = [];
            option.series[1].data = state.current1;
            state.current2 = [];
            option.series[2].data = state.current2;
        });
        ...
        const option = reactive({
            ...
            yAxis: {
                ...
                max: function(value) {
                    let max = 5;
                    if (value.max > 5) max = Math.floor(value.max) + 1;
                    return max;
                },
            },
            dataZoom: [
