  ...
  <div class="main">
      ...
      <div class="box-container">
        ...
        <div class="box-contents">
          ...
          <div class="box-value">
            ...
            <div class="box-value__value">{{ this.$store.state.gac.latest.d2_in_fr | numFormat('0,0') }}</div>
            <div class="box-value__unit">m<sup>3</sup>/h</div>
          </div>
          <div class="box-value">
    ...
    <div class="bottom-two">
      ...
      <div class="bottom-box">
        ...
        <div class="bottom-box__title">운영지수 <span>{{ this.$store.state.gac.latest.ai_i_operation_count }}</span> 지</div>
    ...
    <div class="bottom-chart">
      <div class="bottom-chart__title">
        ...
        <div class="bottom-chart__timerbox-outter">
          <div class="timerbox">
            {{ this.$store.state.gac.latest.update_time | moment('YYYY-MM-DD HH:mm:ss') }}
          </div>
        </div>
      </div>
      <div class="chart-box">
...
import AIGACLocationChart from '@/components/aio/gac/chart/AIGACLocationChart'
import FilterAndGACSchedulePopup from '@/components/aio/dialog/FilterAndGACSchedulePopup'
