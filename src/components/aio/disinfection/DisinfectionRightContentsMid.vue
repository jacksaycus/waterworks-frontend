        ...
        <div class="big-contents">
          <div class="contents-value">
            ...
            <div class="value-container">
              ...
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_peri1_chlorination | numFormat('0.00') }}</div>
              <div class="value-container__two">{{ this.$store.state.disinfection.latest.g_peri2_chlorination | numFormat('0.00') }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="three-small-contents">
          ...
          <div class="three-small-contents-value">
            ...
            <div class="three-value">
              <div class="three-value__num">{{ this.$store.state.disinfection.latest.ai_g_peri1_chlorination | numFormat('0.00') }}</div>
            ...
            <div class="three-value">
              <div class="three-value__num">{{ this.$store.state.disinfection.latest.ai_g_peri2_chlorination | numFormat('0.00') }}</div>
              <div class="three-value__unit">ppm</div>
            </div>
            <div class="three-contents-value-underbar"></div>
          </div>
...
export default {
  ...
  computed: {
    ChartOptionEvaporation: function () {
      ...
      chart.series = []
      if (this.$store.state.disinfection.pre_evaporation['series' + this.selectedLine] !== null && Object.keys(this.$store.state.disinfection.pre_evaporation['series' + this.selectedLine]).length > 0) {
        let yesterdayData = []
        let todayData = []
